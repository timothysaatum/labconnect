    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department_name', models.CharField(choices=[('Haematology', 'Haematology'), ('Microbiology', 'Microbiology'), ('Parasitology', 'Parasitology'), ('Biochemistry', 'Biochemistry')], max_length=100)),
            ],
            options={
                'abstract': False,
            },
