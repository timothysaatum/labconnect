...
from .views import (CreateDeliveryView, DeliveryListView, DeliveryDetailView, 
	DeliveryUpdateView, DeliveryDeleteView, AllDelivery, CreatePriceModelView, UpdatePriceModelView, DeletePriceModelView, PriceModels)
...
urlpatterns = [
	...
	path('price-models/', PriceModels.as_view(), name='all-pricemodel'),
]