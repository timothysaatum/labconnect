    ...
    <div className="container mx-auto p-4  min-h-screen flex items-center justify-center">
      <Card className="w-full max-w-4xl mx-auto shadow-lg">
                ...
                <div key={i} className="flex flex-col items-center">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold ${
                      i <= step
                        ? `bg-gradient-to-r ${getStepColor(i)}`
                  ...
                  <div
                    className={`mt-2 text-xs ${i <= step ? "text-primary" : "text-gray-400"}`}
                  >
                    {["Basic", "Description", "Summary"][i - 1]}
                  </div>
                </div>
              ))}
            </div>
                ...
                >
                  {step === 1 && (
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <FormBuilder name={"main_email"} label={"Email"}>
                        <div className="relative">
                          <Mail className="absolute  left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                          <Input type="text" className="pl-10" />
                        </div>
                      </FormBuilder>
                      <FormBuilder name={"main_phone"} label={"Phone Number"}>
                        <PhoneInput type="text" defaultCountry="GH" />
                      </FormBuilder>
                    </div>
                  )}
                  ...
                  {step === 2 && (
                    <div className="space-y-6">
                      <FormBuilder
                        ...
                        description={
                          "We Recommend you in this section you tell us about your laboratory.Include your mission and vision statements. Elaborate on your specialities and various departments. you can also include awards and achievements"
                        }
                      >
                        <div className="relative">
                  ...
                  {step === 3 && (
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <div>
                          <img
                            src={URL.createObjectURL(form.getValues(""))}
                            alt="hjedhehehehe"
                          />
                        </div>
                      </div>
        ...
        <CardFooter className="flex justify-between rounded-b-lg">
          {step > 1 && (
            <Button variant="outline" onClick={handlePrevSTep}s>
              Previous
            </Button>
          )}
          {step < 3 ? (
