...
const MagicButton = ({ title, icon=null, position=null, otherClasses=null, ...rest }) => {
  return (
    <button
      className="max-w-56 w-full sm:w-56  relative inline-flex h-12 overflow-hidden rounded-lg p-[2px] focus:outline-none"
      {...rest}
    >
