    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_status', models.CharField(choices=[('Request Made', 'Request Made'), ('Request Terminated', 'Request Terminated'), ('Request Accepted', 'Request Accepted'), ('Sample Received by Delivery', 'Sample Received by Delivery'), ('Sample Received by Lab', 'Sample Received by Lab'), ('Request Completed', 'Request Completed')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(db_index=True, default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('status', models.CharField(choices=[('Request Made', 'Request Made'), ('Request Terminated', 'Request Terminated'), ('Request Accepted', 'Request Accepted'), ('Sample Received by Delivery', 'Sample Received by Delivery'), ('Sample Received by Lab', 'Sample Received by Lab'), ('Request Completed', 'Request Completed')], db_index=True, max_length=50)),
