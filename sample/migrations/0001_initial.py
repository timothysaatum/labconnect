    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_status', models.CharField(choices=[('Request Made', 'Request Made'), ('Sample Received by Delivery', 'Sample Received by Delivery'), ('Sample Received by Lab', 'Sample Received by Lab'), ('Testing Sample', 'Testing Sample'), ('Request Completed', 'Request Completed'), ('Request Accepted', 'Request Accepted')], max_length=100)),
